...
def run_commands(
    commands: List[str], encoding: str = "utf-8"
    ...
    result = subprocess.run(
        commands, stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=subprocess.PIPE
    )
